...
import { Clipboard, Link2, Unlink } from "lucide-react";
import { useCallback, useState } from "react";
import { decodeUrlComponent, encodeUrlComponent } from "@/lib/url";

type LastAction = "encode" | "decode" | null;

const PLACEHOLDER = "Your converted result will appear here...";
...
export function UrlTool() {
  ...
  const copyDisabled = lastAction === null || Boolean(error);
    ...
    <div className="max-w-6xl space-y-6">
      <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900/80">
        ...
        <textarea
          ...
          placeholder="Plain text or percent-encoded string..."
          spellCheck={false}
          autoComplete="off"
        />
      </div>
